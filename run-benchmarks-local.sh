...
GODOT_DEBUG="$GODOT_REPO_DIR/Godot_v4.3-stable_linux.x86_64"
...
GODOT_RELEASE="$GODOT_REPO_DIR/Godot_v4.3-stable_linux.x86_64"
...
echo "$(head -c -1 results.md),$EXTRA_JSON}" > "$OUTPUT_PATH"
